...
require (
	...
	github.com/smartcontractkit/chainlink-aptos v0.0.0-20260226134839-2d809a891483
...
require (
	...
	github.com/smartcontractkit/chainlink-testing-framework/framework v0.14.7 // indirect
